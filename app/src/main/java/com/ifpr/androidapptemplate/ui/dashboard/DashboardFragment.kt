...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        nomeEditText = view.findViewById(R.id.enderecoItemEditText)
         tipo = view.findViewById(R.id.TipoItemEditText)
    ...
    private fun salvarItem() {
        ...
        val endereco = nomeEditText.text.toString().trim()
        val tipo = nomeEditText.text.toString().trim()
        if (endereco.isEmpty() || tipo.isEmpty()) {
    ...
    private fun uploadImageToFirestore() {
        if (imageUri != null) {
            ...
            if (bytes != null) {
                ...
                val item = Item(nome, base64Image, tipo)
